...
const Folder = ({
  ...
  items = [
    <a
      href="https://twitter.com/Arnav_Gupta_7"
      target="_blank"
      rel="noopener noreferrer"
      className="flex text-4xl h-[100%] justify-center items-center"
    >
      X
    </a>,

    <a
      href="https://github.com/Arnav-Gupta-CR7"
      target="_blank"
      rel="noopener noreferrer"
      className="flex text-xs pr-2 h-[100%] justify-end-safe items-center"
    >
      gitHub
    </a>,

    <a
      href="https://linkedin.com/in/arnav-gupta-7636752b7"
      target="_blank"
      rel="noopener noreferrer"
